...
final class GrParser {
        ...
        case list_:
            ...
            case equal:
                ...
                case task:
                    ...
                    return grBool;
                case real_:
                    addInstruction(GrOpcode.equal_realList);
                    return grBool;
                case string_:
            ...
            case notEqual:
                ...
                case task:
                    ...
                    return grBool;
                case real_:
                    addInstruction(GrOpcode.notEqual_realList);
                    return grBool;
                case string_:
            ...
            case concatenate:
                ...
                case task:
                    ...
                    return varType;
                case real_:
                    addInstruction(GrOpcode.concatenate_realList);
                    return varType;
                case string_:
    ...
    package void parseScript(GrData data, GrLexer lexer, int options) {
        ...
        while (!isEnd()) {
            ...
            case functionType:
                ...
                break;
            case integerType: .. case chanType:
            case autoType:
            case identifier:
            case type_:
            case instance:
    ...
    private GrType parseFunctionReturnType() {
        ...
        if (get().isType) {
            ...
            case stringType:
                ...
                break;
            case listType:
                returnType = GrType(GrType.Base.list_);
                break;
            case functionType:
    ...
    */
    ...
    private GrType parseChannelBuilder() {
        GrType chanType = GrType.Base.channel;
        int channelSize = 1;
    ...
    */
    private void parseLoopStatement() {
        ...
        if (get().type == GrLexemeType.leftParenthesis) {
            ...
            /* Init */
            iterator = registerSpecialVariable("itérateur", GrType(GrType.Base.integer));
    ...
    */
    private GrType parseListBuilder() {
        GrType listType = GrType(GrType.Base.list_);
        ...
        case enumeration:
            ...
            break;
        case real_:
            addInstruction(GrOpcode.list_real, listSize);
            break;
        case string_:
    ...
    private void addDefaultValue(GrType type, uint fileId) {
        ...
        case list_:
            ...
            case enumeration:
                ...
                break;
            case real_:
                addInstruction(GrOpcode.list_real, 0);
                break;
            case string_:
